  ...
  return (
    <div name='work' className='w-full md:h-screen text-gray-300  '>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 text-gray-300 border-underline'>
            Work
          </p>
...
<div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
  ...
  <div
    ...
    className="  transition duration-300 shadow-lg shadow-gray-800 group container rounded-md 
